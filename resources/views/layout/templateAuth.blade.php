            ...
            <div class="flex flex-col w-full max-w-3xl px-8 mx-auto">
                <header class="bg-[#3e73c9] text-white py-2 shadow-md">
                    <div class="container mx-auto flex justify-center items-center">
                        <div class="container mx-auto flex flex-col items-center max-w-lg w-full p-4 shadow-lg transition-transform duration-100 transform hover:scale-105 bg-white rounded-xl"> 
