...
<body class="bg-blue-600 font-[Poppins]">
    ...
    <div class="sidebar" id="sidebar">
        <div class="text-gray-100 text-sm sm:text-md">
            ...
            <a href="{{ route('admin.dashboard') }}" class="p-2.5 mt-2 flex items-center px-4 duration-300 cursor-pointer hover:bg-gray-700 {{ Request::routeIs('admin.dashboard') ? 'bg-gray-700' : '' }}">
                <i class="bi bi-house-door"></i>
                <span class="text-[15px] ml-4 text-gray-200">Home</span>
            </a>
            <a href="{{ route('requests') }}" class="p-2.5 mt-2 flex items-center px-4 duration-300 cursor-pointer hover:bg-gray-700 {{ Request::routeIs('requests') ? 'bg-gray-700' : '' }}">
                <i class="bi bi-person-check-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200">Persetujuan Akun</span>
            </a>
            <a href="{{ route('lihatPermintaanPeminjaman') }}" class="p-2.5 mt-2 flex items-center px-4 duration-300 cursor-pointer hover:bg-gray-700 {{ Request::is('lihatPermintaanPeminjaman') ? 'bg-gray-700' : '' }}">
                <i class="bi bi-check-square-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200">Persetujuan Peminjaman</span>
            </a>
            <a href="/return-requests" class="p-2.5 mt-2 flex items-center px-4 duration-300 cursor-pointer hover:bg-gray-700 {{ Request::is('return-requests*') ? 'bg-gray-700' : '' }}">
                <i class="bi bi-arrow-return-left"></i>
                <span class="text-[15px] ml-4 text-gray-200">Persetujuan Pengembalian Aset</span>
            </a>
            <a href="{{ route('asset.create') }}" class="p-2.5 mt-2 flex items-center px-4 duration-300 cursor-pointer hover:bg-gray-700 {{ Request::is('admin/asset/tambah') ? 'bg-gray-700' : '' }}">
                <i class="bi bi-plus-circle"></i>
                <span class="text-[15px] ml-4 text-gray-200">Tambah Aset</span>
            </a>
            <a href="{{ route('asset.index') }}" class="p-2.5 mt-2 flex items-center px-4 duration-300 cursor-pointer hover:bg-gray-700 {{ Request::is('admin/asset') ? 'bg-gray-700' : '' }}">
                <i class="bi bi-list-ul"></i>
                <span class="text-[15px] ml-4 text-gray-200">Lihat Aset</span>
            </a>
            <a href="/check-availability" class="p-2.5 mt-2 flex items-center px-4 duration-300 cursor-pointer hover:bg-gray-700 {{ Request::is('check-availability') ? 'bg-gray-700' : '' }}">
                <i class="bi bi-eye-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200">Cek Ketersediaan Aset</span>
            </a>
            <hr class="my-4 text-gray-600">
            <a href="{{ route('lihat.peminjam.aktif') }}" class="p-2.5 mt-2 flex items-center px-4 duration-300 cursor-pointer hover:bg-gray-700 {{ Request::is('peminjamaktif') ? 'bg-gray-700' : '' }}">
                <i class="bi bi-people-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200">Lihat Peminjam</span>
            </a>
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="p-2.5 mt-2 flex items-center px-4 duration-300 cursor-pointer hover:bg-gray-700 w-full">
