...
@section('content')
    <div class="container mx-auto py-8">
        <h2 class="text-3xl font-bold mb-6 text-gray-800">Keranjang Peminjaman Alat Misa Anda</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($keranjangItems as $item)
                        <div class="border p-4 rounded-lg shadow-md bg-white relative">
                            ...
                            @php
                                $stokTersedia = $item->jumlah - $item->jumlah_terpinjam;
                            @endphp
                            ...
                            <div class="mt-4">
                                ...
                                <label for="item_{{ $item->id }}" class="text-sm text-gray-600 ml-2">Pilih alat misa
                                    untuk
                                    checkout</label>
                            </div>
                        </div>
        ...
        function confirmCheckout() {
            ...
            if (selectedItems.length === 0) {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Pilih setidaknya satu alat misa untuk checkout.',
