...
<section class="p-6 bg-gray-100 min-h-screen place-items-center ">
    ...
    <body class="bg-gray-100 flex justify-center items-center min-h-screen w-full h-full ">
