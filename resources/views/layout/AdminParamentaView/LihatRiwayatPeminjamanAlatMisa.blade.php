...
@section('content')
    ...
    <div class="container mx-auto py-8">
        ...
        <div class="flex justify-center mb-6">
            <div class="bg-gray-100 p-1 rounded-lg shadow-lg inline-flex">
                ...
                <button class="tab-btn px-6 py-2 flex items-center bg-gray-200 text-gray-700"
                    data-target="pengembalianContent">
                    <i class="fas fa-undo mr-2"></i> Pengembalian
                </button>
                <button class="tab-btn px-6 py-2 rounded-r-lg flex items-center bg-gray-200 text-gray-700"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            tabs.forEach(tab => {
                tab.addEventListener('click', () => {
                    // Hapus kelas 'active' dari semua tab dan sembunyikan semua content
