...
<head>
    ...
    <title>Status Pengembalian</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            @if ($status == 'approved')
                <p> Terima Kasih Telah Menggunakan Barang di Paroki Babadan </p>
            ...
            @else
                ...
                @if ($alasan)
                    ...
                    <p>Silahkan Melakukan permintaan Pengembalian Ulang, atau Hubungi Admin</p>
                @endif
            @endif
            <ul class="item-list">
                <li>Nama: {{ $assetDetails['nama_barang'] }}</li>
                <li>Jumlah: {{ $assetDetails['jumlah'] }}</li>
            </ul>
