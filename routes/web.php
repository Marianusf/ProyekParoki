...
Route::get('/keranjang', [PeminjamController::class, 'DaftarRuangan'])->name('FormRuangan');
Route::post('/keranjang/tambah', [PeminjamanController::class, 'DaftarRuangan'])->name('keranjang.tambah');
